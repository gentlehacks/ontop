...
const Header = () => {
    ...
    return (
        <div className="fixed z-100 top-4 left-0 w-full mx-auto flex items-center justify-center px-6 md:px-8">
            <ul className="w-[85%] md:w-[70%] lg:w-[60%] px-8 py-3 md:py-4 rounded-full bg-yellow-300/10 backdrop-filter backdrop-blur-sm gap-6 md:gap-8 border-[1px] border-yellow-700 flex items-center justify-center">
