...
const ProjectCard = ({id, image, name}: Props) => {
    ...
    return (
        <li className="relative overflow-hidden border-1 border-yellow-600 rounded-2xl shadow-md h-100">
            <Image
                src={`/${image}.jpg`}
                alt={name}
                width={500}
            ...
            from-[rgba(0, 0, 0, 0)] via-[rgba(173, 162, 7, 0.29)] to-[rgb(0,0,0)] ">
                <h1 className="text-[1rem] text-yellow-500 font-semibold flex items-center ml-5">
